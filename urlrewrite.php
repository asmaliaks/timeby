...
$arUrlRewrite = array(
	...
	array(
		"CONDITION" => "#^/e-store/watches/decoration/#",
		"RULE" => "",
		"ID" => "bitrix:catalog",
		"PATH" => "/e-store/watches/decoration/index.php",
	),
	array(
		"CONDITION" => "#^/e-store/watches/presents/#",
		"RULE" => "",
		"ID" => "bitrix:catalog",
		"PATH" => "/e-store/watches/presents/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/e-store/watches/#",
		"RULE" => "",
		"ID" => "bitrix:catalog",
		"PATH" => "/e-store/watches/index.php",
	),
	array(
	...
	array(
		"CONDITION" => "#^/e-store/clocks/#",
		"RULE" => "",
		"ID" => "bitrix:catalog",
		"PATH" => "/e-store/clocks/index.php",
	),
	array(
