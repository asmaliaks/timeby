...
<?
		...
		{
?>              <?php if($arOneProp['CODE'] != 'VIDEO_REVIEW'){?>
...
<?
    ...
    <?php if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']) && !empty($arResult['OFFERS_PROP']))
{
	$arSkuProps = array();
?>
  ...
  <!--  video review-->  
   <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SORT_ORDER1" => "DESC",
		"DETAIL_URL" => "video-review/page.php?ID=#ELEMENT_ID#",
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "300"
	)
);?><br>
