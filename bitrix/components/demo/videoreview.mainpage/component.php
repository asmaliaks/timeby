...
//                ">DATE_CREATE" => $to,
	...
	$rsItems = CIBlockElement::GetList($arOrder, $arFilter, false,array("nTopCount"=>1), $arSelect);
	while($arItem = $rsItems->GetNext())
	{
                ...
                $aditionalsItems = CIBlockElement::GetList($aditionalOrder, $aditionalFilter, false,array("nTopCount"=>2), $additionalSelect);
                $n = 0;
